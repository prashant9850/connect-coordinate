...
const availabilityStyles = {
  ...
  busy: 'bg-severity-orange text-severity-orange',
...
export function VolunteerList({ volunteers, maxDisplay = 5, className }: VolunteerListProps) {
        ...
        >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-2">
              <h4 className="font-medium text-foreground truncate">{volunteer.name}</h4>
              <span className={cn(
