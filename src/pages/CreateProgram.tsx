...
import { ArrowLeft, MapPin, AlertTriangle, Check } from "lucide-react";
...
const severityOptions: {
...
}[] = [
  {
    ...
    color: "border-severity-red bg-severity-red-bg text-severity-red",
  },
  {
    value: "orange",
    label: "High",
    description: "Urgent situation requiring rapid response",
    color: "border-severity-orange bg-severity-orange-bg text-severity-orange",
  },
  {
    value: "yellow",
    label: "Moderate",
    description: "Significant situation, response needed",
    color: "border-severity-yellow bg-severity-yellow-bg text-severity-yellow",
  },
];
        ...
        <div className="bg-card border border-border rounded-xl p-6">
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-foreground mb-2">
              Create Relief Program
            </h1>
            <p className="text-muted-foreground">
              Start a new disaster relief program to coordinate volunteers and
              resources.
            </p>
          </div>
              ...
              <div className="flex flex-wrap gap-2">
                {disasterTypes.map((type) => (
                  <button
                    ...
                    type="button"
                    onClick={() =>
                      setFormData({ ...formData, disasterType: type })
                    }
                    className={cn(
